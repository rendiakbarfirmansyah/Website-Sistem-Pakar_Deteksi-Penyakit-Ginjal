      ...
      <div class="container">
        <div class="row">
          <div class="col align-self-center">
            ...
            <p class="mb-4">
            Ginjak Qu adalah aplikasi diagnostik yang dirancang untuk membantu pengguna mendeteksi kemungkinan adanya penyakit ginjal. Melalui teknologi sistem pakar, aplikasi ini menganalisis gejala dan informasi medis pengguna untuk memberikan evaluasi awal terkait kesehatan ginjal. Dengan antarmuka yang user-friendly, Ginjak Qu memudahkan pengguna mendapatkan wawasan kesehatan ginjal secara cepat dan praktis, serta memberikan rekomendasi untuk tindakan lanjutan jika diperlukan.
            </p>
      ...
      <div id="konten2" class="container konten">
        ...
        <div class="card-deck">
          <div class="card">
            ...
            <img src="gambar/login_logo.jpg" class="card-img-top" alt="...">
            <div class="card-body">
          ...
          <div class="card">
            ...
            <img src="gambar/tes_pasien.jpg" class="card-img-top" alt="...">
            <div class="card-body">
          ...
          <div class="card">
            ...
            <img src="gambar/hasil_pasien.png" class="card-img-top" alt="...">
